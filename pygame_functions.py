...
keydict = {"space": pygame.K_SPACE, "esc": pygame.K_ESCAPE, "up": pygame.K_UP, "down": pygame.K_DOWN,
           "left": pygame.K_LEFT, "right": pygame.K_RIGHT, "return": pygame.K_RETURN, "shift" : pygame.K_LSHIFT,
           "a": pygame.K_a,
           "b": pygame.K_b,
           "c": pygame.K_c,
           "d": pygame.K_d,
...
def touching(sprite1, sprite2):
    ...
    return collided
def touching2(sprite1, sprite2):
    collided2 = pygame.sprite.collide_rect(sprite1, sprite2)
    return collided2
